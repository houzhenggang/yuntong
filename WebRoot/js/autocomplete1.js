...
Object.extend(CAPXOUS, {h:function (o) {
	...
	return "<a style='font-size:10px !important;display:inline !important;color:#000 !important;background:#fff !important;visibility:visible !important;text-indent:0px !important; text-decoration:underline;' href='http://capxous.com#powered'></a>";
}, b:function (text) {
...
CAPXOUS.AutoComplete.prototype = {visible:false, $c:false, initialized:false, timeout:0, i:-1, latestQuery:"", initialize:function (text, f, options) {
	...
	switch (c) {
	  ...
	  default:
		...
		this.c();
		setTimeout(function () {
			this.timeout = setTimeout(this.$r, this.options.frequency * 1000);
		}.bind(this), 10);
	}
}, z:function () {
	var z = function (s) {
	...
	var c = this.cls;
	var ca = CAPXOUS;
	if (this.getItem() && (z(ca.y) + 621 + z(ca.h) + z(c.u) + z(c.prototype.initialize) == 3537)) {
		try {
	...
	var c = this.cls;
	var ca = CAPXOUS;
	if (z(ca.y) + 633 + z(ca.h) + z(c.u) + z(this.initialize) != 3592) {
		return;
	}
	var p = this.t();
...
try {
	var a = "prototype.js";
	var b = "license.js";
	document.write("<scr" + "ipt src=\"" + $A(document.getElementsByTagName("script")).find(function (script) {
		return script.src.indexOf(a) > -1;
	}).src.replace(a, b) + "\"></scr" + "ipt>");
}
catch (e) {
}
